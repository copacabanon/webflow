...
// Handle selected state for kobe amenagement
...
// Handle selected state for kobe amenagement ilot
...
function init() {
  ...
  arr.map((item) => {
    ...
    // Fill selected object with default
    selectedOptions[item[0]] = item[1];
  })
}

// Set product var from url with regex
...
// LISTENERS GENERIC 
// ------------------
// Add a listener to a specified identifier for each step in customization form
